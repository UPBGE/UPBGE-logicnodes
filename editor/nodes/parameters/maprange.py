...
class LogicNodeMapRange(LogicNodeParameterType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicFloat, "From Max", {'default_value': 1.0})
        self.add_input(NodeSocketLogicFloat, "To Min")
        self.add_input(NodeSocketLogicFloat, "To Max", {'default_value': 1.0})
        self.add_input(NodeSocketLogicFloat, 'Steps', {'enabled': False})
        self.add_input(NodeSocketLogicVectorXYZ, "Value")
        self.add_input(NodeSocketLogicVectorXYZ, "From Min")
        self.add_input(NodeSocketLogicVectorXYZ, "From Max", {'default_value': (1.0, 1.0, 1.0)})
        self.add_input(NodeSocketLogicVectorXYZ, "To Min")
        self.add_input(NodeSocketLogicVectorXYZ, "To Max", {'default_value': (1.0, 1.0, 1.0)})
        self.add_input(NodeSocketLogicVectorXYZ, 'Steps', {'enabled': False})
