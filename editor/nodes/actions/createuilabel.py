...
class LogicNodeCreateUILabel(LogicNodeActionType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicInteger, "Font Size", None, {'default_value': 12})
        ...
        self.add_input(NodeSocketLogicVectorXY, "Shadow Offset", None, {'default_value': (1., -1.)})
        self.add_input(NodeSocketLogicColorRGBA, "Shadow Color", None, {'default_value': (0, 0, 0, .5)})
