...
class LogicNodeCreateUISlider(LogicNodeActionType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicVectorXY, "", {'default_value': (200., 10.)})
        self.add_input(NodeSocketLogicFloatAngle, "Angle")
        self.add_input(NodeSocketLogicFloatPositive, "Bar Width", {'default_value': .5})
        ...
        self.add_input(NodeSocketLogicColorRGBA, "Bar Color", {'default_value': (.1, .1, .1, .5)})
        self.add_input(NodeSocketLogicColorRGBA, "Bar Hover Color", {'default_value': (.1, .1, .1, .7)})
        self.add_input(NodeSocketLogicImage, "Bar Texture", {'enabled': False})
        self.add_input(NodeSocketLogicFloatPositive, "Knob Size", {'default_value': 1.0})
        self.add_input(NodeSocketLogicColorRGBA, "Knob Color", {'default_value': (.7, .8, 1., 1.)})
        ...
        self.add_input(NodeSocketLogicBoolean, "Bar Control", {'default_value': True})
