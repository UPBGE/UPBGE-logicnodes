...
@node_type
class LogicNodeToggleLogicTreeProperty(LogicNodeActionType):
    bl_idname = "LogicNodeToggleLogicTreeProperty"
    bl_label = "Toggle Tree Property"
    bl_description = 'Toggle a property of a tree'
    nl_module = 'uplogic.nodes.actions'
    nl_class = "ToggleLogicTreePropertyNode"
