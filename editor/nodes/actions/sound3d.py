...
class LogicNodeSound3D(LogicNodeActionType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicFloatPositive, "Volume", {'value': 1.0})
        self.add_input(NodeSocketLogicBoolean, "Enable Reverb")
        self.add_input(NodeSocketLogicFloatPositive, "Attenuation", {'value': 1.0})
        self.add_input(NodeSocketLogicFloat, "Reference Distance", {'value': 1.0})
        self.add_input(NodeSocketLogicVectorXY, "Cone Inner / Outer", {'value_x': 360, 'value_y': 360})
        self.add_input(NodeSocketLogicFloat, "Cone Outer Volume", {'value': 0.0})
