...
class LogicNodeFollowPath(LogicNodeActionType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicFloatPositive, "Lin Speed", {'value': 1.0})
        self.add_input(NodeSocketLogicFloatPositive, "Reach Threshold", {'value': .2})
        self.add_input(NodeSocketLogicBoolean, "Look At", {'value': True})
        self.add_input(NodeSocketLogicFloatFactor, "Rot Speed", {'value': 1.0})
