...
class LogicNodeFollowPath(LogicNodeActionType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicFloatPositive, "Lin Speed", {'default_value': 1.0})
        self.add_input(NodeSocketLogicFloatPositive, "Reach Threshold", {'default_value': .2})
        self.add_input(NodeSocketLogicBoolean, "Look At", {'default_value': True})
        self.add_input(NodeSocketLogicFloatFactor, "Rot Speed", {'default_value': 1.0})
