...
class LogicNodeCreateUIButton(LogicNodeActionType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicColorRGBA, "Color", {'default_value': (0, 0, 0, 0)})
        self.add_input(NodeSocketLogicColorRGBA, "Hover Color", {'default_value': (0, 0, 0, .5)})
        self.add_input(NodeSocketLogicIntegerPositive, "Border Width", {'default_value': 1})
        self.add_input(NodeSocketLogicColorRGBA, "Border Color", {'default_value': (0, 0, 0, 0)})
        self.add_input(NodeSocketLogicString, "Text")
        self.add_input(NodeSocketLogicVectorXY, "Text Position", {'default_value': (.5, .5)})
        self.add_input(NodeSocketLogicFont, "Font")
        self.add_input(NodeSocketLogicIntegerPositive, "Font Size", {'default_value': 12})
        self.add_input(NodeSocketLogicFloat, "Line Height", {'default_value': 1.5})
        self.add_input(NodeSocketLogicColorRGBA, "Font Color", {'default_value': (1, 1, 1, 1)})
