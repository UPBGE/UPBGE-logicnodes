...
class LogicNodeVehicleCreate(LogicNodeActionType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicFloat, "Suspension", None, {'default_value': .06})
        self.add_input(NodeSocketLogicFloat, "Stiffness", None, {'default_value': 50})
        self.add_input(NodeSocketLogicFloat, "Damping", None, {'default_value': 5})
        self.add_input(NodeSocketLogicFloat, "Friction", None, {'default_value': 2})
        self.add_input(NodeSocketLogicFloatPositive, "Wheel Modifier", None, {'default_value': 1})
