...
class LogicNodeRaycastProjectile(LogicNodeActionType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicFloatPositive, "Power", {'default_value': 10.0})
        self.add_input(NodeSocketLogicFloatPositive, "Distance", {'default_value': 20.0})
        self.add_input(NodeSocketLogicFloatFactor, "Resolution", {'default_value': 0.9})
