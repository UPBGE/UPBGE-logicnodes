...
class LogicNodeGamepadLook(LogicNodeActionType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicFloatPositive, 'Sensitivity', {'default_value': .25})
        self.add_input(NodeSocketLogicFloatPositive, 'Exponent', {'default_value': 2.3})
        ...
        self.add_input(NodeSocketLogicFloatPositive, 'Threshold', {'default_value': .1})
