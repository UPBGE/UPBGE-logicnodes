...
class LogicNodeSpawnPool(LogicNodeActionType):
    ...
    def init(self, context):
        ...
        self.add_input(NodeSocketLogicIntegerPositive, "Amount", {'default_value': 10})
        self.add_input(NodeSocketLogicIntegerPositive, "Life", {'default_value': 3})
        self.add_input(NodeSocketLogicFloatPositive, "Speed", {'default_value': 75.0})
