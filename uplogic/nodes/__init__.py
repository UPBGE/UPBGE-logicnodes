...
class ActionSetMousePosition(GEActionNode):
    def __init__(self):
...
class ParameterMouseData(GEParameterNode):
    def __init__(self):
...
class ConditionMouseScrolled(GEConditionNode):
    def __init__(self):
...
class ConditionGamepadButtons(GEConditionNode):
...
class ConditionGamepadButtonUp(GEConditionNode):
    def __init__(self, pulse=False, button=0):
        GEConditionNode.__init__(self)
        self.pulse = pulse
        self.button = button
...
class ConditionGamepadSticks(GEConditionNode):
    ...
    def evaluate(self):
        ...
        self._x_axis_values = values[0]
        self._y_axis_values = values[1]
